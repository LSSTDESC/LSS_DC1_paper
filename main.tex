...
The final products of this pipeline are FITS images with information about the observing conditions. We generated more than 200,000 images in total (including both the \textit{dithered}, and \textit{undithered} fields). The typical time to simulate each CCD is  seconds\textcolor{red}{Check how long it took to do one chip?/Total imSim time}.
