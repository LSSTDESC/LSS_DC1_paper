...
\caption{Shot-noise subtracted measured power-spectra for the detected objects by the LSST stack (solid blue circles), the objects in the true catalog spatially matched (open orange circles), the objects with $21.4 \leq r_{\rm true} \leq 25.3$ (red crosses), and the objects with $21.4 \leq r_{\rm emulated} \leq 25.3$ (green triangles).}
