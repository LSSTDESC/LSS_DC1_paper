...
We have processed the output individual-visit catalogs through the LSST Project package ``validate_drp'',\footnote{\url{dmtn-0008.lsst.io}}\footnote{\url{https://github.com/lsst/validate_drp}}
which is designed to calculate the Key Performance Metrics from the LSST Science Requirements Document~\citep{LPM-17}.
