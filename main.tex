...
\begin{abstract}
  ...
  project requirements on key performance parameters. We establish a
  ...
  image generation, the LSST pipeline passes all Key Performance Metrics (KPMs);
