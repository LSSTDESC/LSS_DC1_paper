...
The photometric error model from \citet[][Eq. 6,7]{Ivezic2008} is
\begin{eqnarray}
...
\begin{equation}
m_5 = C_m + 0.50 (m_{\rm sky} - 21~{\rm mag/{\rm arcsec}^2}) + 2.5 \log_{10} (0.7{\rm arcsec}/\theta_{\rm eff}) + 1.25 \log_{10} (t_{\rm vis} / 30~{\rm s}) - k_m (X-1)
\end{equation}
...
Our fits find $m_5$ = 24.2~mag/\arcsec^2, $\gamma=0.038$ which are quite consistent with the \citet[][Table 2]{Ivezic2008} values of $m_5=24.35$~mag/\arcsec^2, $\gamma=0.039$.  This validates that were are generating simulations of the telescope, detector, and sky in accordance with the \citet{Ivezic2008} estimates.
...
(upper right) The RMS distribution as a function of magnitude of the star.  Here you can see the tight core of very repeatibile measurements, along with a smaller population of objects with much higher scatter to their measurements.
...
Detailed astrometric performance.  (left) Histogram of the repeatability of distance between pairs of stars.  (right) Astrometric variation as a function of SNR.  We find a systematic floor of 12~milliarcsec.
 ...
 {\bf TODO: MWV IS THIS HISTOGRAM DIFFERENT THAN THE check_photometry histogram in terms of per-pair vs. per-object variation.}
}
