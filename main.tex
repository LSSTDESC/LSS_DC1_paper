...
the design of this data challenge.  In \secref{inputs}, we describe the inputs for our simulated images, including the observing strategies used for this study. In \secref{design}, we describe the  generation, and reduction of LSST-like artificial images. In \secref{matching}, we summarize the factors that informed the design of DC1, plus the inputs used and dither strategies employed when producing the simulations. In \secref{catalogs}, we describe the data products generated and perform several validation tests. In \secref{data_selection} we describe the procedure to obtain a clean sample of galaxies suitable for clustering analyses. In \secref{results}, we present the clustering analyses on the simulated data products. Finally, in \secref{conclusions}, we present some concluding remarks.
